...
export default function PurchaseInvoicesPage() {
  const [invoices, setInvoices] = useState([
    {
      ...
      purchase_order: { po_number: "PO-1001" },
    ...
    },
    {
      ...
      purchase_order: { po_number: "PO-1002" },
    ...
    },
    {
      ...
      purchase_order: { po_number: "PO-1003" },
  ...
  const handleSubmitNewInvoice = () => {
    if (!invoiceNumber || !supplierId || totalAmount <= 0) {
      setNotification({
        type: "error",
        message: "Invoice #, Supplier, and valid Total are required.",
      });
      return;
    }
  ...
  return (
    <>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Track and manage all supplier invoices.
                </p>
              </div>
              <button
      ...
      <Modal
        ...
        title={
          <>
            <FiPlusCircle className="w-6 h-6" /> New Purchase Invoice
          </>
        }
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="0.00"
              value={totalAmount}
              onChange={(e) => setTotalAmount(parseFloat(e.TOS) || 0)}
              className="w-full bg-slate-50 border border-slate-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
        </div>
